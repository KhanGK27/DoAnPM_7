...
namespace WebBanDienThoai.Areas.Admin.Controllers
{
    ...
    public class AdminSanPhamController : Controller
    {
        ...
        public AdminSanPhamController(BanDienThoaiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaSp,MaDm,TenSp,AnhSp,VideoSp,ThuongHieu,GiaSp,TrangThai,BestSeller,CreateDate,MotaSp")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaSp,MaDm,TenSp,AnhSp,VideoSp,ThuongHieu,GiaSp,TrangThai,BestSeller,CreateDate,MotaSp")] SanPham sanPham)
        {
            if (id != sanPham.MaSp)
            {
                return NotFound();
