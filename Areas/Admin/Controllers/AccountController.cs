...
namespace WebBanDienThoai.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(BanDienThoaiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AccountId,TaiKhoan,MatKhau,Phone,Email,FullName,CreateDate")] Account account)
        {
